...
class game1:
    ...
    def randomfood(self):
        self.foodpoint= random.randint(100,400),random.randint(100,600)
          
    def update(self,imgmain,currenthead):
        
       if self.gameover:
            cvzone.putTextRect(imgmain,"Game Over",(100,150),scale=3,thickness=3,offset=10)
            cvzone.putTextRect(imgmain,f'Your Score:{self.score}',(100,250),scale=3,thickness=3,offset=10)
